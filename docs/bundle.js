...
function displayTopWord(response){
  ...
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('article.word-count').empty()
  let wordInfo =  response['word'];
  let word = Object.keys(wordInfo)[0];
  let count = wordInfo[word];
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('article.word-count').prepend(`<div>${word} : ${count}</div>`)
}

function getTopWord(){__WEBPACK_IMPORTED_MODULE_0_jquery___default.a.ajax({
  type:"GET",
...
async function postWordList(event){
  var wordList = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('textarea').val().split(" ")
  ...
  for( var word of wordList){
    if(word != ""){
      ...
      await __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.ajax({
        type:"POST",
        url: url,
        data: data,
        success: successFunc,
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).ready( () => {
  ...
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('button').on('click', postWordList)
  // have fun!
